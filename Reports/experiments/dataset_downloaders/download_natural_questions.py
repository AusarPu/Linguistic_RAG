...
class NaturalQuestionsDownloader(BaseDownloader):
    """Natural Questions 数据集下载器"""
    
    def __init__(self):
        super().__init__()
        self.dataset_name = "Natural Questions"
        self.dataset_id = "google-research-datasets/natural_questions"
    
    def _download_raw(self):
        """仅下载 Natural Questions 原始数据到缓存"""
