...
DENSE_QUESTION_RETRIEVAL_TOP_K=20,
SPARSE_KEYWORD_RETRIEVAL_TOP_K=20,
DENSE_CHUNK_THRESHOLD=0.6,  # 你设定的 0.6
DENSE_QUESTION_THRESHOLD=0.6  # 你设定的 0.8
# -----------------------------

# --- 模型本地路径配置 ---
# vLLM 使用的基础模型 (Generator 和 Rewriter 都用这个) 的本地路径
# !! 需要确保这个路径在新设备上是正确的 !!
VLLM_BASE_MODEL_LOCAL_PATH = "/home/pushihao/RAG/models/Qwen/Qwen3-30B-A3B-FP8" #<--- 修改为你 base_llm 下载的实际路径
